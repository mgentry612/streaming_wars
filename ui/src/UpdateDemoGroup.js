...
function UpdateDemoGroup(props) {
    ...
    return (
        <div>
            Update Demographic Group<br /><br />
            <div>
            ...
            <input type="button" onClick={updateDemoGroupLocal} value="Done" />
...
export default UpdateDemoGroup;